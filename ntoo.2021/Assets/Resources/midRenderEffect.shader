Shader "Hidden/Shader/midRenderEffect"
{
    HLSLINCLUDE
    ...
    float4 CustomPostProcess(Varyings input) : SV_Target
    {
        ...
        float oneOrZero= 1.0 - floor(getRandomValue+0.5 - clamp((_Contrast * outColor.r),0.,0.5));
        
        float morePixelation = (1.0 - getRandomValue2);
        outColor.rgb = outColor.rgb*oneOrZero;// * morePixelation;
